...
| Package | Purpose |
| --- | --- |
| `core` | runtime, scenes, fixed clock, events, services, scheduler, pools, checkpointable seeded random |
...
| `input` | actions, contexts, keyboard, pointer/touch gestures, and isolated or any-controller gamepad polling |
| `audio` | lazy sound definitions, buses, managed playlists, cooldowns, and concurrency |
